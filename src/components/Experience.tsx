  ...
  const experiences = [
    {
      ...
      achievements: [
        "Developed advanced medical image processing algorithms",
        "Optimized data pipelines for real-time analysis",
        "Implemented computer vision solutions for diagnostic tools"
      ],
    ...
    },
    {
      ...
      achievements: [
        ...
        "Reduced false positives significantly improving user experience",
    ...
    },
    {
      ...
      achievements: [
        "Developed CNN models for protein structure analysis",
        "Achieved 92% accuracy improvement in crystallization prediction",
        "Collaborated with biochemistry researchers"
      ],
      ...
      <div className="container mx-auto px-6">
        ...
        <div className="space-y-8">
          {experiences.map((exp, index) => (
            <Card
              key={index}
              className={`bg-card border-border/50 card-hover relative overflow-hidden ${
                exp.current ? 'border-primary/50 bg-gradient-to-r from-primary/5 to-transparent' : ''
              }`}
            >
              {exp.current && (
